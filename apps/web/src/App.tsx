            ...
            <AnimatePresence mode="wait">
              <Routes>
                ...
                {!isAuthenticated ? (
                  ...
                  <>
                    {/* The root path for authenticated users is now handled by LandingPage,
                        so we can remove the explicit redirect to dashboard here.
                        LandingPage itself should handle redirection if needed. */}
